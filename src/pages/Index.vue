<template>
  ...
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">How sweet it is for teams to succeed 
      ...
      <div class="flex justify-center">
          <g-link to="/#reachout" class="text-copy-primary hover:text-gray-600"> <button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Contact Us</button></g-link>

      </div>
    </div>
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
            <g-image class="object-cover object-center rounded" width="750" alt="hero" src="~/assets/images/pass-the-honey-vZGvVTO1pIg-unsplash.jpg" />
    </div>
  </div>
</section>
    ...
    <!-- <div class="newsletter bg-background-tertiary">
      ...
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Join Our Newsletter</h1>
        ...
        <div class="w-4/5 mx-auto mb-8">
          ...
          <p class="leading-relaxed text-base pb-4">Sensible advice and words of consolation delivered to you  monthly 
          <form action="#">
